...
function update_check_requirements($skip_warnings = FALSE) {
  ...
  if ($severity == REQUIREMENT_ERROR || ($severity == REQUIREMENT_WARNING && !$skip_warnings)) {
    ...
    $task_list = update_task_list('requirements');$status_report = t('Resolve the problems and 
    <a href="!url">try again</a>.', array('!url' => check_url(backdrop_requirements_url($severity))));
    $status_report .= '<br><br>';
